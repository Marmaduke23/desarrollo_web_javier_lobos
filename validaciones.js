...
const validateForm = () => {
    ...
    if (!validateText(sector,100,false)) {
    ...
    if ((whastapp.style.display== "block" && !(validateUrl(whastapp.value)||validatePhoneNumber(whastapp.value)))) {
      setInvalidInput("Whatsapp");
    }
    if ((telegram.style.display== "block" && !(validateUrl(telegram.value)||validatePhoneNumber(telegram.value)))) {
